...
async function generateResponseCode(openai, senderNumber) {
    ...
    const languageDetectionPrompt = `Detect the language and text format of the following message: '${lastMessage}'. Respond only in Urdu, Hindi, or English, using Roman script. The response should match the formality of the original message, whether formal or informal.`;
